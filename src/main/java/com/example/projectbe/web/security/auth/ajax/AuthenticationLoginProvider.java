...
public class AuthenticationLoginProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        List<GrantedAuthority> grantedAuthorities = Collections.singletonList(new SimpleGrantedAuthority(userToAuthenticate.getUserRole().getRepresentation()));
        UserAuthenticationInfo authenticationInfo = new UserAuthenticationInfo(userToAuthenticate.getEmail(),userToAuthenticate.getUserRole().getRepresentation(),  grantedAuthorities);
