package com.example.projectbe.web.security.util;
...
public class JWTUtil {
    ...
    public String generateJWTToken(UserAuthenticationInfo authenticationInfo) {
        ...
        return JWT.create()
                ...
                .withClaim("role", authenticationInfo.getRole())
                .withClaim("scopes", authenticationInfo.getGrantedAuthorities().stream().map(GrantedAuthority::getAuthority).collect(Collectors.toList()))
